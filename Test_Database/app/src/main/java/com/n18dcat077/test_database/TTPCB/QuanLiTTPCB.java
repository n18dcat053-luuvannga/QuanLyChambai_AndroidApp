...
public class QuanLiTTPCB extends AppCompatActivity implements TTPCBAdapter.TTPCBClickListener{
    ...
    public void setEvent(){
        ...
        ttpcbAdapter = new TTPCBAdapter(this, R.layout.phieuchambai_item,data,this::select);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ttpcbAdapter.getFilter().filter(query);
                return false;
            }
            @Override
            public boolean onQueryTextChange(String newText) {
                ttpcbAdapter.getFilter().filter(newText);
                return false;
            }
    ...
    @Override
    public void select(PCB pcb) {
        startActivity(new Intent(this, SuaTTPCB.class).putExtra("data",pcb));
