...
public class GiaoVienAdapter_phu extends ArrayAdapter<GiaoVien>{
    ...
    public GiaoVienAdapter_phu(@NonNull Context context, int resource, @NonNull ArrayList<GiaoVien>data) {
